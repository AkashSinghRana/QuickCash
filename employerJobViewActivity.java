...
public class employerJobViewActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewJobButton = findViewById(R.id.employerViewJobButton);
        viewJobButton.setOnClickListener(this);

        Bundle value = getIntent().getExtras();
        user = value.getString("user");

        jobName = findViewById(R.id.employerJobNameLabel);
        locationLabel = findViewById(R.id.employerLocationLabel);
        payLabel = findViewById(R.id.employerPayLabel);
        dateLabel = findViewById(R.id.employerDateLabel);
        durationLabel = findViewById(R.id.employerDurationLabel);
        urgencyLabel = findViewById(R.id.employerUrgencyLabel);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot values : snapshot.getChildren()){
                    String value = values.child("6").getValue(String.class);
    ...
    public void setJobView(ArrayList<String> abc){
        ...
        jobs = findViewById(R.id.employerJobs);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(jobs.getSelectedItem().toString().equals("Jobs")){
                    Toast.makeText(employerJobViewActivity.this, "Please select a job", Toast.LENGTH_LONG).show();
                }
                else {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.employerViewJobButton:
